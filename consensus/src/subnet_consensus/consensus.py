...
from subnet_network.hypertensor.chain_data import SubnetNodeConsensusData
from subnet_network.hypertensor.chain_functions import Hypertensor, SubnetNodeClass
from subnet_network.hypertensor.config import BLOCK_SECS
...
from subnet_network.utils.pubsub.heartbeat import HEARTBEAT_TOPIC
...
class Consensus:
    ...
    async def get_scores(self, current_epoch: int) -> List[SubnetNodeConsensusData]:
        ...
        included_nodes = await self.subnet_info_tracker.get_nodes_v2(
            current_epoch, SubnetNodeClass.Included
        )
